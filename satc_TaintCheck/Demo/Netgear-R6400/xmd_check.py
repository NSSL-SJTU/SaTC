...
def main():
    ...
    start_addr = 0x8c420 # address of bl FUN_0002babc()
    # avoid_addr = [] # addresses we want to avoid
    avoid_addr = []
    success_addr = 0xa8c438 # address of code block leading to "That is correct!"
...
#    simgr.use_technique(tech)
    ...
    if simulation.found:
        ...
        solution = solution_state.solver.eval(param1, cast_to=bytes) # concretize the symbolic bitvector
